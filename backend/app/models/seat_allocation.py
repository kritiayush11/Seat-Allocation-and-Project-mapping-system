...
class SeatAllocation(Base):
    ...
    allocation_status = Column(SAEnum(AllocationStatus), default=AllocationStatus.ACTIVE, nullable=False, index=True)
    ...
    # Composite index for fast active-allocation lookups
    __table_args__ = (
