...
from sqlalchemy import Column, Integer, String, Date, DateTime, ForeignKey, Enum as SAEnum, Boolean
...
class Employee(Base):
    ...
    def active_allocation(self):
        """Returns the employee's current active seat allocation, if any."""
